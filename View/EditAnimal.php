...
<section class="flex-column w-100 d-flex align-items-center justify-content-center">
    ...
    <form method="post" class="col-6">
        ...
        <input type="text" name="nom" id="nom" class="form-control" value="<?= $animal['nom']?>" >
        <label for="date_naissance">Date de naissance de l'animal :</label>
        <input type="date" name="date_naissance" id="date_naissance" class="form-control" value="<?= $animal['date_naissance']?>">
        ...
        <select name="id_es" id="id_es" class="form-select" value="<?= $animal['id_es']?>">
...
<script>
    ...
    form.addEventListener("submit", (event) => {
        ...
        console.log(data)
        fetch("../Controller/AdminController?UpdatePetsConfirm",
            {
                method: "POST",
                headers: {
